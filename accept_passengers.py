...
class AcceptPassenger(customtkinter.CTkToplevel):
    def __init__(self,passenger_info, *args, **kwargs):
        ...
        self.passenger_label = customtkinter.CTkLabel(master = self.passenger_requests_frame,text=self.passenger_info['passenger_name']+ " "+self.passenger_info['passenger_age']+ " "+self.passenger_info.get('passenger_finaldest'))
